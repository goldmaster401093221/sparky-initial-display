...
const Dashboard = () => {
  ...
  const sidebarItems = [
    { icon: CustomHomeIcon, label: 'Home', route: '/', active: false },
    { icon: Users, label: 'Dashboard', route: '/dashboard', active: true },
    { icon: Users, label: 'Discover Collaborators', route: '/discover-collaborators', active: false },
    { icon: Bookmark, label: 'Saved Collaborators', route: '/saved-collaborators', active: false },
  ];

  const collaborationItems = [
    { icon: MessageSquare, label: 'Collaboration', route: '/collaboration', active: false },
    { icon: MessageSquare, label: 'Chat', route: '/chat', active: false },
    { icon: Database, label: 'Data Center', route: '/data-center', active: false },
  ];

  const supportingServices = [
    { icon: Ship, label: 'Shipment', route: '/shipment', active: false },
    { icon: FileText, label: 'Quotation', route: '/quotation', active: false },
    { icon: Wrench, label: 'Equipment', route: '/equipment', active: false },
  ];
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gray-50">
        <Sidebar className="border-r border-gray-200">
                  ...
                  {sidebarItems.map((item, index) => (
                    <SidebarMenuItem key={index}>
                      <SidebarMenuButton
                        ...
                        className={`w-full justify-start ${item.active ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-gray-700 hover:bg-gray-100'}`}
          ...
          <SidebarFooter className="p-4 border-t border-gray-200 space-y-4">
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
              ...
              <Card className="p-4 lg:p-6">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <svg width="20" height="18" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-6 lg:h-6">
                  ...
                  <div>
                    <div className="text-xs lg:text-sm text-gray-600">Total Collaborations</div>
              ...
              <Card className="p-4 lg:p-6">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-green-100 rounded-lg flex items-center justify-center">
                    <svg width="16" height="15" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-5 lg:h-4">
                  ...
                  <div>
                    <div className="text-xs lg:text-sm text-gray-600">Total Collaborators</div>
                    <div className="text-2xl lg:text-3xl font-bold">16</div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4 lg:p-6">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                    <svg width="15" height="16" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-4 lg:h-5">
                  ...
                  <div>
                    <div className="text-xs lg:text-sm text-gray-600">Total Collaboration Days</div>
                    <div className="text-2xl lg:text-3xl font-bold">322</div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4 lg:p-6">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                    <svg width="18" height="12" viewBox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-5 lg:h-4">
                  ...
                  <div>
                    <div className="text-xs lg:text-sm text-gray-600">Total Meetings</div>
                    <div className="text-2xl lg:text-3xl font-bold">322</div>
                  </div>
                </div>
              </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 lg:gap-6">
                <div className='lg:col-span-2'>
                  <div className="p-4 lg:p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-sm text-gray-600 mb-6 space-y-1 sm:space-y-0">
