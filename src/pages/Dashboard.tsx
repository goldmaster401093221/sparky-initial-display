...
const AppSidebar = ({ profile, navigate }: { profile: Profile | null, navigate: any }) => {
  // Custom Icons Start
  ...
  const sidebarItems = [
    ...
    { icon: Users, label: 'Dashboard', active: true, route: '/dashboard' },
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen bg-gray-50 flex w-full">
        <AppSidebar profile={profile} navigate={navigate} />
        ...
        <SidebarInset className="flex-1">
          ...
          <div className="flex-1 p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
              <Card className="p-4 sm:p-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm text-gray-600">Total Collaborations</div>
              ...
              <Card className="p-4 sm:p-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm text-gray-600">Total Collaboration Days</div>
                    <div className="text-2xl sm:text-3xl font-bold">322</div>
                  </div>
                </div>
              </Card>
            ...
            <div className="flex justify-end mb-6">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base px-4 py-2">
